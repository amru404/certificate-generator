                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <a href="{{ route('superadmin.participant.edit', $p->id) }}" class="btn btn-warning btn-sm mx-1"><i class="fa-regular fa-pen-to-square"></i></a>
                            <a href="{{ route('superadmin.participant.destroy', $p->id) }}" class="btn btn-danger btn-sm mx-1" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash"></i></a>
                            @if ($p->certificate)
                                <a href="{{ route('superadmin.certificate.pdf', $p->id) }}" class="btn btn-success btn-sm mx-1">PDF</a>
                            @else

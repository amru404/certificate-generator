...
<div class="certificate-container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div id="certificate-preview" 
        ...
        <!-- Nama -->
        <div id="preview-nama" 
             style="position:absolute; top:40%; left:50%; border: 1px solid red;  transform:translate(-50%, -50%); font-size:24px; font-weight:bold; color:#333; text-shadow: 1px 1px 4px rgba(0, 0, 0, 0.3);">
            amru azzam
        </div>

        <!-- Deskripsi -->
        <div id="preview-deskripsi" 
             style="position:absolute; top:55%; left:50%; transform:translate(-50%, -50%); font-size:18px; color:#555; text-align:center; font-weight:500;">
        ...
        <div id="preview-uid" 
            ...
            UID: {{ $template->certificate ? $template->certificate->id : 'UID tidak tersedia' }}
        </div>

        <!-- Signature -->
        <img id="signature-image" 
             src="{{ asset('storage/' . $template->ttd) }}" 
             alt="Signature" 

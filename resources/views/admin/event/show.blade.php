...
<div class="card-header">
    ...
    <a href="{{ route('admin.certificate.create', $detail_event->id) }}" 
...
<div class="row">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                @if($detail_event->logo)
                    <img src="{{ asset('storage/' . $detail_event->logo) }}" alt="Logo Event" class="img-fluid" style="max-height: 200px;">
                @else
    ...
    <div class="card mt-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group">
                <a href="{{ route('admin.participant.import.create', $detail_event->id) }}" class="btn btn-sm" style="background-color:#2D3E50;color:white;">Add Participant</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <a href="{{ route('admin.participant.edit', $p->id) }}" class="btn btn-warning btn-sm mx-1"><i class="fa-regular fa-pen-to-square"></i></a>
                            <a href="{{ route('admin.participant.destroy', $p->id) }}" class="btn btn-danger btn-sm mx-1" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash"></i></a>
                            @if ($p->certificate)
                                <a href="{{ route('admin.certificate.pdf', $p->id) }}" class="btn btn-success btn-sm mx-1">PDF</a>
                            @else
